...
class MethodChannelVideoPlayer extends VideoPlayerPlatform {
  ...
  Future<void> setDisplayRoi(int texureId, int x, int y, int w, int h) {
    return _api.setDisplayRoi(GeometryMessage()
      ..textureId = texureId
      ..x = x
      ..y = y
      ..w = w
  ...
  Stream<VideoEvent> videoEventsFor(int textureId) {
    return _eventChannelFor(textureId)
      ...
      switch (map['event']) {
        ...
        case 'Seeking':
          return VideoEvent(eventType: VideoEventType.seeking, ret: map['ret']);
        case 'ResourceConflicted':
          return VideoEvent(eventType: VideoEventType.resourceConflicted);
        case 'StopReachEvent':
          return VideoEvent(
              eventType: VideoEventType.stopReachEvent, ret: map['ret']);
        case 'StateChangedToPlaying':
          return VideoEvent(eventType: VideoEventType.stateChangedToPlaying);
        case 'ChangeSourceDone':
          return VideoEvent(
              eventType: VideoEventType.changeSourceDone, ret: map['ret']);
        default:
