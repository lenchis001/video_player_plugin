...
abstract class VideoPlayerPlatform {
  ...
  Future<void> setDisplayRoi(int texureId, int x, int y, int w, int h) {
    throw UnimplementedError('setDisplayRoi() has not been implemented.');
  }
...
/// The Drm Type which the video is encrypted.
///
...
enum DrmType {
  ...
  /// The video Drm type is playready.
  playready,
...
enum VideoEventType {
  ...
  /// The H/W resource is conflicted.
  resourceConflicted,

  /// The stop reach event.
  stopReachEvent,
