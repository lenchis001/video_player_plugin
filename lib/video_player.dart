...
import 'src/video_player_platform_interface.dart';
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
    ...
    void eventListener(VideoEvent event) {
      ...
      switch (event.eventType) {
        ...
        case VideoEventType.bufferingEnd:
          ...
          break;
        case VideoEventType.seeking:
          value = value.copyWith(isSeeking: event.ret);
          break;
        case VideoEventType.changeSourceDone:
          break;
        case VideoEventType.resourceConflicted:
          break;
        case VideoEventType.stateChangedToPlaying:
          break;
        case VideoEventType.stopReachEvent:
          break;
  ...
  Future<void> setDisplayRoi(int texureId, int x, int y, int w, int h) async {
    return await _videoPlayerPlatform.setDisplayRoi(texureId, x, y, w, h);
  }
