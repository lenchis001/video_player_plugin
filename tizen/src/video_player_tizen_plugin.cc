...
void VideoPlayerTizenPlugin::RegisterWithRegistrar(
    ...
    flutter::PluginRegistrar *pluginRegistrar) {
  auto plugin =
      std::make_unique<VideoPlayerTizenPlugin>(registrar_ref, pluginRegistrar);
...
VideoPlayerTizenPlugin::VideoPlayerTizenPlugin(
    FlutterDesktopPluginRegistrarRef registrar_ref,
    flutter::PluginRegistrar *pluginRegistrar)
    : registrar_ref_(registrar_ref), pluginRegistrar_(pluginRegistrar) {
...
TextureMessage VideoPlayerTizenPlugin::create(const CreateMessage &createMsg) {
  ...
  auto player = std::make_unique<VideoPlayer>(registrar_ref_, pluginRegistrar_,
                                              uri, options_);
