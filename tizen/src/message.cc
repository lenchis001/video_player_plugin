...
int CreateMessage::getDrmType() const
{
  return drm_type_;
}

void CreateMessage::setDrmType(int nDrmType)
{
  drm_type_ = nDrmType;
}
...
flutter::EncodableValue CreateMessage::toMap() {
  ...
  flutter::EncodableMap toMapResult = {
      ...
      {flutter::EncodableValue("formatHint"),
       ...
       {flutter::EncodableValue("drmType"),
              flutter::EncodableValue(drm_type_)},
...
CreateMessage CreateMessage::fromMap(const flutter::EncodableValue &value) {
  ...
  if (std::holds_alternative<flutter::EncodableMap>(value)) {
    ...
    flutter::EncodableValue &drmType =
        emap[flutter::EncodableValue("drmType")];
    ...
    if (std::holds_alternative<std::string>(licenseServerUrl)) {
      fromMapResult.setLicenseServerUrl(std::get<std::string>(licenseServerUrl));
